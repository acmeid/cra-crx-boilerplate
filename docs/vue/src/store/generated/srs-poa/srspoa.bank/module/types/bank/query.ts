...
export const protobufPackage = "srspoa.bank";
...
export class QueryClientImpl implements Query {
  ...
  Balance(request: QueryBalanceRequest): Promise<QueryBalanceResponse> {
    ...
    const promise = this.rpc.request("srspoa.bank.Query", "Balance", data);
  ...
  AllBalances(
    ...
    const promise = this.rpc.request("srspoa.bank.Query", "AllBalances", data);
    return promise.then((data) =>
  ...
  TotalSupply(
    ...
    const promise = this.rpc.request("srspoa.bank.Query", "TotalSupply", data);
    return promise.then((data) =>
  ...
  SupplyOf(request: QuerySupplyOfRequest): Promise<QuerySupplyOfResponse> {
    ...
    const promise = this.rpc.request("srspoa.bank.Query", "SupplyOf", data);
    return promise.then((data) =>
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("srspoa.bank.Query", "Params", data);
