...
export interface RegionCommission {
  ...
  /** 未生效金额 */
  delegatorsInvalidBondDenomAmount: string;
  jailed: boolean;
}
...
const baseRegionCommission: object = {
  ...
  accountName: "",
  accountAddress: "",
  delegatorsInvalidBondDenomAmount: "",
  jailed: false,
};
...
export const RegionCommission = {
  encode(message: RegionCommission, writer: Writer = Writer.create()): Writer {
    ...
    if (message.delegatorsInvalidBondDenomAmount !== "") {
      writer.uint32(98).string(message.delegatorsInvalidBondDenomAmount);
    }
    if (message.jailed === true) {
      writer.uint32(104).bool(message.jailed);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          break;
        case 12:
          message.delegatorsInvalidBondDenomAmount = reader.string();
          break;
        case 13:
  ...
  fromJSON(object: any): RegionCommission {
    ...
    if (
      object.delegatorsInvalidBondDenomAmount !== undefined &&
      object.delegatorsInvalidBondDenomAmount !== null
    ) {
      message.delegatorsInvalidBondDenomAmount = String(
        object.delegatorsInvalidBondDenomAmount
      );
    } else {
      message.delegatorsInvalidBondDenomAmount = "";
    }
  ...
  toJSON(message: RegionCommission): unknown {
    ...
    message.delegatorsInvalidBondDenomAmount !== undefined &&
      (obj.delegatorsInvalidBondDenomAmount =
        message.delegatorsInvalidBondDenomAmount);
