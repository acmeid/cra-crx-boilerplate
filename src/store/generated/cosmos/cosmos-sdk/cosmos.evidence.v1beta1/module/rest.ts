...
export interface V1Beta1MsgSubmitEvidenceResponse {
  /**
   * hash defines the hash of the srsevidence.
   * @format byte
   */
  hash?: string;
}
...
export interface V1Beta1QueryAllEvidenceResponse {
  /** srsevidence returns all evidences. */
...
export interface V1Beta1QueryEvidenceResponse {
  /** srsevidence returns the requested srsevidence. */
  evidence?: ProtobufAny;
}
...
/**
 * @title cosmos/srsevidence/v1beta1/srsevidence.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @summary AllEvidence queries all srsevidence.
   * @request GET:/cosmos/srsevidence/v1beta1/srsevidence
   */
  queryAllEvidence = (
    query?: {
   ...
   * @tags Query
   * @name QueryEvidence
   * @summary Evidence queries srsevidence based on srsevidence hash.
   * @request GET:/cosmos/srsevidence/v1beta1/srsevidence/{evidence_hash}
   */
