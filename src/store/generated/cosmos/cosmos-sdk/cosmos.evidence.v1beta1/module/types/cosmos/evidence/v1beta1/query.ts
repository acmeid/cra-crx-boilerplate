...
export const protobufPackage = "cosmos.srsevidence.v1beta1";

/** QueryEvidenceRequest is the request type for the Query/Evidence RPC method. */
export interface QueryEvidenceRequest {
  /** evidence_hash defines the hash of the requested srsevidence. */
...
export interface Query {
  /** Evidence queries srsevidence based on srsevidence hash. */
  Evidence(request: QueryEvidenceRequest): Promise<QueryEvidenceResponse>;
  /** AllEvidence queries all srsevidence. */
  AllEvidence(
...
export class QueryClientImpl implements Query {
  ...
  Evidence(request: QueryEvidenceRequest): Promise<QueryEvidenceResponse> {
    ...
    const promise = this.rpc.request(
      "cosmos.srsevidence.v1beta1.Query",
      "Evidence",
      data
    );
