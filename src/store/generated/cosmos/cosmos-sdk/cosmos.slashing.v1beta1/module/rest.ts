...
/**
 * Params represents the parameters used for by the srslashing module.
 */
...
/**
 * @title cosmos/srslashing/v1beta1/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryParams
   * @summary Params queries the parameters of srslashing module
   * @request GET:/cosmos/srslashing/v1beta1/params
   */
   ...
   * @request GET:/cosmos/srslashing/v1beta1/signing_infos
   */
  querySigningInfos = (
    query?: {
   ...
   * @request GET:/cosmos/srslashing/v1beta1/signing_infos/{cons_address}
   */
