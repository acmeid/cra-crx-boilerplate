...
/** EvidenceParams determine how we handle srsevidence of malfeasance. */
export interface EvidenceParams {
  /**
   * Max age of srsevidence, in blocks.
   *
  ...
  /**
   * Max age of srsevidence, in time.
   *
  ...
  /**
   * This sets the maximum size of total srsevidence in bytes that can be committed in a single block.
