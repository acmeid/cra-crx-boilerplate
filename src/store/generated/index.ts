...
import SrsPoaSrspoaSrsevidence from './srs-poa/srspoa.srsevidence'
import SrsPoaSrspoaSrslashing from './srs-poa/srspoa.srslashing'
import SrsPoaSrspoaSrsmint from './srs-poa/srspoa.srsmint'
import SrsPoaSrspoaSrstaking from './srs-poa/srspoa.srstaking'
import SrsPoaSrspoaSrvault from './srs-poa/srspoa.srvault'
...
export default { 
  ...
  SrsPoaSrspoaSrsevidence: load(SrsPoaSrspoaSrsevidence, 'srspoa.srsevidence'),
  SrsPoaSrspoaSrslashing: load(SrsPoaSrspoaSrslashing, 'srspoa.srslashing'),
  SrsPoaSrspoaSrsmint: load(SrsPoaSrspoaSrsmint, 'srspoa.srsmint'),
  SrsPoaSrspoaSrstaking: load(SrsPoaSrspoaSrstaking, 'srspoa.srstaking'),
  SrsPoaSrspoaSrvault: load(SrsPoaSrspoaSrvault, 'srspoa.srvault'),
