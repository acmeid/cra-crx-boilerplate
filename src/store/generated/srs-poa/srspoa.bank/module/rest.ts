...
*/
export interface BankQuerySpendableBalancesResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/srs-poa/bank/balances/{address}
   */
  queryAllBalances = (
    address: string,
    query?: {
    ...
    this.request<BankQueryAllBalancesResponse, RpcStatus>({
      path: `/srs-poa/bank/balances/${address}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/srs-poa/bank/denoms_metadata
   */
  queryDenomsMetadata = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BankQueryDenomsMetadataResponse, RpcStatus>({
      path: `/srs-poa/bank/denoms_metadata`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/srs-poa/bank/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BankQueryParamsResponse, RpcStatus>({
      path: `/srs-poa/bank/params`,
      method: "GET",
      format: "json",
      ...params,
    });
...
account.
 * @request GET:/srs-poa/bank/spendable_balances/{address}
 */
  querySpendableBalances = (
    ...
    this.request<BankQuerySpendableBalancesResponse, RpcStatus>({
      path: `/srs-poa/bank/spendable_balances/${address}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/srs-poa/bank/supply
   */
  queryTotalSupply = (
    query?: {
      "pagination.key"?: string;
