...
import { Params, ValidatorSigningInfo } from "../srslashing/slashing";
import {
  PageRequest,
  PageResponse,
} from "../cosmos/base/query/v1beta1/pagination";

export const protobufPackage = "srspoa.srslashing";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("srspoa.srslashing.Query", "Params", data);
